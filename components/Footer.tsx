...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#0a1120] text-slate-400 pt-16 sm:pt-24 pb-8 sm:pb-12 border-t border-white/5 font-sans">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 sm:gap-16 pb-16 border-b border-white/5 text-center sm:text-left">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-y-4 mb-8">
              {navLinks.map(l => (
                <Link key={l.name} to={l.href} className="text-[14px] font-light active:text-white py-1">
                  {l.name}
                </Link>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div>
                <a href="tel:+905454678762" className="text-xl sm:text-2xl font-bold text-white tracking-tight active:text-amber-500">
                  +90 545 467 8762
                </a>
        ...
        {/* Bottom Legal - Enhanced for Mobile Visibility & Touch */}
        <div 
        ...
        >
          ...
          <div className="flex gap-6 sm:gap-8">
            <Link 
              to="/privacy" 
              className="text-[12px] sm:text-[10px] text-slate-500 active:text-amber-500 py-2 uppercase tracking-wider font-medium"
            >
