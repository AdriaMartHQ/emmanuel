  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center bg-[#050a18] overflow-hidden text-center">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 flex flex-col items-center">
        ...
        <h2 className="text-white text-4xl md:text-5xl font-black tracking-[0.15em] mb-4 uppercase">
          EMMANUEL GLOBAL LIAISON
        </h2>
        
        <div className="text-amber-500 text-xl font-bold tracking-[0.8em] mb-12 border-y border-amber-600/20 py-4 w-full">
          以马内利 · 国际执行
        </div>

        <div className="inline-flex px-8 py-3 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm text-slate-400 text-xs font-medium tracking-[0.3em] uppercase mb-16">
          跨境交流逻辑 · 专业咨询专家
        </div>
